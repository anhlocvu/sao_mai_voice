...
addon_info = AddonInfo(
	...
	addon_changelog=_(""""""),
	# Author(s)
	addon_author="LC Boy <https://lc.ktgame207.com>",
	# URL for the add-on documentation support
	addon_url="https://github.com/anhlocvu/sao_mai_voice",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/anhlocvu/sao_mai_voice",
...
pythonSources: list[str] = ["addon/synthDrivers/*.py", "addon/globalPlugins/sao_mai_voice/*.py"]
